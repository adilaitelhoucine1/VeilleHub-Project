    ...
    <div class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg">
        ...
        <nav class="mt-6">
            ...
            <div class="px-4 py-4 space-y-2">
                <a href="/Etudiant/dashboard" class="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 rounded-lg">
                ...
                <a href="/Etudiant/suggestions" class="flex items-center px-4 py-3 bg-blue-50 text-blue-600 rounded-lg">
